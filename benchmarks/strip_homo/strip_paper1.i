...
[Materials]
  [props]
    ...
    prop_values = '4.4449 4.8342 9.7000 35.6331 3.6000 55.0089'
  []
  [orientation1]
    type = GenericConstantRankTwoTensor
    tensor_name = M1
    # tensor_values = '0.9570 -0.2028 0 -0.2028 0.0430 0 0 0 0'
    tensor_values = '0.5105 0.4999 0 0.4999 0.4895 0 0 0 0'
  []
  [orientation2]
    type = GenericConstantRankTwoTensor
    tensor_name = M2
...
[Outputs]
  [csv]
    type = CSV
    file_base = './iden_s_e/paper1/stress_xx_sample_${sample}'
  []
  exodus = true
[]
[Postprocessors]
