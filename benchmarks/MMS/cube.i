...
[Kernels]
  [xbody]
    type = BodyForce
    variable = 'disp_x'
    function = '(2*exp(z))/25 + (57*exp(3*z)*exp(exp(4*z)/625000000000))/781250 + (19*exp(7*z)*exp(exp(4*z)/625000000000))/122070312500000000 + (9*exp(z)*(exp(2*z) + 30000)^(1/2))/10000 + (9*exp(3*z))/(10000*(exp(2*z) + 30000)^(1/2))'
  []
  # [ybody]
  #   type = BodyForce
  #   variable = 'disp_y'
  ...
  [zbody]
    type = BodyForce
    variable = 'disp_z'
    function = '(exp(2*z)*((9*(exp(2*z) + 30000)^(1/2))/100 + 4))/7500 - (19*exp(6*z)*exp(exp(4*z)/625000000000))/1220703125000000 - (76*exp(2*z)*exp(exp(4*z)/625000000000))/15625 + (3*exp(4*z))/(500000*(exp(2*z) + 30000)^(1/2))'
  []
  [solid_x]
